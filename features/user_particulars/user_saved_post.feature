...
Scenario: Empty Saved Post page
    Given there are no saved posts
...
Scenario: Adding a saved post and removing it in Saved Post page
    ...
    And the "Gebirah Aid Giveaway", ID: "1" event card should not be present
    When I press the "Back" button
    Then the "Gebirah Aid Giveaway", ID: "1" event card should be present
