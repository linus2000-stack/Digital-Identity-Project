Feature: Search for Services Page

Background:
    Given I am now on the user particulars home page as a verified user

Scenario: Navigating to the Search for Services page
    When I press on the "Search for Services" button
    Then I should be redirected to the "Search for Services" page
...
Scenario: Searching for Services
    Given I am on the "Search for Services" page
