...
Then('I should be directed to the {string} page') do |page|
...
Then('I should see an error message stating {string}') do |message|
...
When('I click on the {string} button next to the uploaded document') do |button|
